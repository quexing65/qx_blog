...
配套的 [2015—2018 多年度销售数据](https://github.com/quexing65/qx_blog/releases/download/dataset-v1/sales-multiyear.xlsx) 包含 `2015`、`2016`、`2017`、`2018` 和 `会员等级` 五个工作表。前四张订单表使用 `会员ID`、`订单号`、`提交日期`、`订单金额` 四个字段，适合练习跨年度读取、合并、分组与对比。

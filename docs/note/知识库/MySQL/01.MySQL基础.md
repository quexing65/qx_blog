...
| (-2147483648，INT/INTEGER | 4bytes | (0，4294967295)2147483647) | 大整数值 |
|   |   |   | 极大 |
| BIGINT | 8bytes (-2^63，2^63-1) | (0，2^64-1) | 整数 |
|   |   |   | 值 |
|   |   |   | 单精 |
| (-3.402823466 E+38，FLOAT | 4bytes 3.402823466351 E+38) | 0 和 (1.175494351 E-38，3.402823466 E+38) | 度浮点数 |
|   |   |   | 值 |
| DOUBLE | 8bytes | 0 和(-1.7976931348623157 (2.2250738585072014 E+308，E-308， | 双精度浮 |
...
| 检查约束之后) | (8.0.16版本 | 保证字段值满足某一个条件 |   |   | CHECK |
...
| id | ID唯一标识 | int | 主键，并且自动增长 | PRIMARY AUTO_INCREMENT | KEY, |

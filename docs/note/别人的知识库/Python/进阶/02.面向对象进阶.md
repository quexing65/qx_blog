...
> 集中学习继承、封装、多态、抽象类、类属性、类方法和静态方法；完整项目放在下一篇独立实践。
...
[上一步：01.面向对象基础](01.面向对象基础.md) [下一步：03.学生管理系统-OOP版](03.学生管理系统-OOP版.md) [返回总索引](关于Python进阶.md)
